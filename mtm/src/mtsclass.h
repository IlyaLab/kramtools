...
/**
  * Unlike statistical class, these are (subject to conventions) mutually 
  * exclusive. However, we use these identifiers to represent HOW WE WILL
  * TREAT tokens, not only WHAT THE TOKENS ARE. Categorical data, for 
  * example, is typically represented as string labels but may also be
  * represented by small integers. Use of bit fields allows us to express
  * that either representation is acceptable.
  */
